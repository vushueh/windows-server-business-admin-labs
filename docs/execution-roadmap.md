...
| B | P03-P04 DNS and DHCP/IPAM integration | Route10 + OPNsense + NetOps monitoring | Routing, DHCP authority, DNS, and monitoring must agree on hostnames and subnets. |
